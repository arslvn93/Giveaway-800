const config = {
  ...
  "prize": {
    "images": [
      ...
      {
        "src": "",
        "alt": "Happy homeowners celebrating their big savings"
      }
    ],
    "includedItems": [
      {
  ...
  "howToEnter": {
    "steps": [
      {
        ...
        "description": "Type your name, address, and email below. Takes 30 seconds or less."
      },
      {
        "icon": "fas fa-question-circle",
        "title": "Answer Quick Questions",
        "description": "We ask simple questions about your plans to sell now or in the future."
      },
      {
        "icon": "fas fa-trophy",
    ...
    "highlights": [
      {
        "icon": "fas fa-clock",
        "text": "Takes less than 1 minute to enter"
      },
      {
        "icon": "fas fa-gift",
  ...
  "thankYouPage": {
    ...
    "mainMessage": "Your entry for the <strong>Vellore Village 1% Listing Commission Discount</strong> is in! We will draw the winner on September 8, 2025 and notify them by email. Good luck!",
  ...
  "footerContact": {
    ...
    "organizerLogoUrl": "data:image/jpeg;base64,",
