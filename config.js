const config = {
  ...
  "thankYouPage": {
    ...
    "socialPromptText": "Tell a friend in Vaughan - more local entries means more people informed and ready to make their next Real Estate move."
  },
  "footerContact": {
    "social": {
    ...
    "footerDisclaimer": "This offer is organized by The Sky Group Real Estate Team. Completely free to enter. No purchase required and no strings attached.",
